...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 5, .adv_w = 261, .box_w = 8, .box_h = 16, .ofs_x = 4, .ofs_y = 2},
    {.bitmap_index = 21, .adv_w = 261, .box_w = 12, .box_h = 20, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 51, .adv_w = 261, .box_w = 2, .box_h = 19, .ofs_x = 12, .ofs_y = 1},
    {.bitmap_index = 56, .adv_w = 261, .box_w = 12, .box_h = 20, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 86, .adv_w = 261, .box_w = 12, .box_h = 20, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 116, .adv_w = 261, .box_w = 12, .box_h = 19, .ofs_x = 2, .ofs_y = 1},
    {.bitmap_index = 145, .adv_w = 261, .box_w = 12, .box_h = 20, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 175, .adv_w = 261, .box_w = 12, .box_h = 20, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 205, .adv_w = 261, .box_w = 12, .box_h = 19, .ofs_x = 2, .ofs_y = 1},
    {.bitmap_index = 234, .adv_w = 261, .box_w = 12, .box_h = 20, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 264, .adv_w = 261, .box_w = 12, .box_h = 20, .ofs_x = 2, .ofs_y = 0}
};
